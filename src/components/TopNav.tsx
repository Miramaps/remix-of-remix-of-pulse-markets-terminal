  ...
  return (
    <header className="sticky top-0 z-50 shrink-0">
      <div className="h-14 grid grid-cols-[1fr_auto_1fr] items-stretch">
        ...
        <div className="bg-primary/8 border-b border-r border-primary/20 rounded-br-2xl flex items-center gap-6 pl-4 md:pl-6 pr-2">
          <button
        ...
        <div className="bg-primary/8 border-b border-l border-primary/20 rounded-bl-2xl flex items-center justify-end gap-2 pr-4 md:pr-6 pl-2">
